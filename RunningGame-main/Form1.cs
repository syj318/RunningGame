...
namespace Running_game
{
    public partial class Form1 : Form
    {
        ...
        void ob(int speed)
        {
            if (pictureBox_ob.Top >= 840)
            {
                x = r.Next(0, 700);
                pictureBox_ob.Location = new Point(x, 0);
            }
            else
            {
                pictureBox_ob.Top += speed;
            }
            if(pictureBox_trash.Top>=840)
            {
                x = r.Next(350, 700);
                pictureBox_trash.Location = new Point(x, 0);
            }
            else
            {
                pictureBox_trash.Top += speed;
            }
        }
